...
import { addCouponRange, queryCouponRange, removeCouponRange, updateCouponRange, queryCouponRangeVerboseName, queryCouponRangeListDisplay, queryCouponRangeDisplayOrder} from './service';
...
const TableList = () => {
  ...
  const handleUpdate = async (value, current_id) => {
    ...
    try {
      await updateCouponRange(value, current_id);
      hide();
  ...
  useEffect(() => {
    queryCouponRangeDisplayOrder().then(r => {
  ...
  useEffect(() => {
    queryCouponRangeListDisplay().then(value => {
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, { selectedRows }) => [
          ...
          <Button type="primary" onClick={() => exportExcelAll(paramState, queryCouponRange, table_columns, '充值方式-All')}>
            <ExportOutlined /> 导出全部
          </Button>,
        ...
        request={(params, sorter, filter) => queryCouponRange({ ...params, sorter, filter })}
