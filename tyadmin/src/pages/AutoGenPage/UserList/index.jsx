 ...
 const handlePassWordUpdate = () => {
  ...
  const base_columns = [{
        ...
        hideInSearch: true,
                             ...
                             initialValue: "https://static.mukewang.com/static/img/avatar_default.png",
                             dataIndex: 'avatar',
                             valueType: 'avatar',
                             rules: [
                                              ...
                                              render: (text, record) => (
                                                <>
                                                  ...
                                                  <EditOutlined title="编辑" className="icon" onClick={async () => {
                                                   record.last_login = record.last_login === null ? record.last_login : moment(record.last_login);record.date_joined = record.date_joined === null ? record.date_joined : moment(record.date_joined);record.create_time = record.create_time === null ? record.create_time : moment(record.create_time);
