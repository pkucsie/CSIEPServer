...
import { addLog, queryLog, removeLog, updateLog, queryLogVerboseName, queryLogListDisplay, queryLogDisplayOrder} from './service';
import UpdateForm from './components/UpdateForm';
import UploadAvatar from '@/components/UploadAvatar';
import {queryLogType, queryLogTypeVerboseName} from '@/pages/AutoGenPage/LogTypeList/service';
...
const TableList = () => {
  ...
  useEffect(() => {
    queryLogListDisplay().then(value => {
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, { selectedRows }) => [
          ...
          <Button type="primary" onClick={() => exportExcelAll(paramState, queryLog, table_columns, '访问日志-All')}>
            <ExportOutlined /> 导出全部
          </Button>,
                ...
                <Menu
                  onClick={async e => {
                    if (e.key === 'remove') {
                      ...
                      exportExcelCurrent(selectedRows, table_columns, '访问日志-select')
                    }
                  }}
                  selectedKeys={[]}
                >
